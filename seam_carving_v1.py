# USAGE:
# python seam_carving_v1.py (-resize | -remove) -im IM -out OUT [-mask MASK]
#                        [-rmask RMASK] [-dy DY] [-dx DX] [-vis] [-hremove] [-backward_energy]
# Examples:
# python seam_carving_v1.py -resize -im demos/ratatouille.jpg -out ratatouille_resize.jpg
#        -mask demos/ratatouille_mask.jpg -dy 20 -dx -200 -vis
# python seam_carving_v1.py -remove -im demos/eiffel.jpg -out eiffel_remove.jpg
...
if __name__ == "__main__":
    ...
    ap.add_argument(
        "-hremove",
        help="Remove horizontal seams for object removal",
        action="store_true",
    )
    ap.add_argument(
        "-backward_energy",
        help="Use backward energy map (default is forward)",
        action="store_true",
    )
    args = vars(ap.parse_args())

    IM_PATH, MASK_PATH, OUTPUT_NAME, R_MASK_PATH = (
        args["im"],
        args["mask"],
        args["out"],
        args["rmask"],
